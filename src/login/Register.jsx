...
const Register = () => {
  ...
  const onSubmit = (data )=> {
    data.pic=data.pic[0].name
    setInputs(data)
    console.log(data.pic[0].name)
    console.log("popped input",inputs)
    axios.post('http://localhost:4001/api/user', data)
    .then((response)=>{
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4"  onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                    <label class="form-label" for="form3Example4c">profile <picture></picture>:</label>
                      <input type="file" 
                      name="pic"
